...
// Generated by mro at 2021-07-21 09:56:45
package postgres
...
func (find *Find) FindUsers1(ids []uint64) ([]*models.User, error){
    var err error
	var1 := "SELECT id,name,age,gender,oka_us_url,cret,url FROM user WHERE id in (@in-1626832606)"
	var var1Params []interface{}
	// where 参数
	if len(ids) <= 0 {
		return nil, dbutil694.NewErrParamIsEmpty("ids")
	}
	var1 = dbutil694.TakePlaceHolder(var1, "@in-1626832606", len(ids))
