...
// Generated by mro at 2021-07-19 17:36:18
package postgres
...
func (find *Find) FindUsers1(ids []uint64) ([]*models.User, error){
    var err error
	sql := "SELECT id,name,age,gender,oka_us_url,cret,url FROM user WHERE id in (@in-1626687378)"
	var sqlParams []interface{}
	// where 参数
	if len(ids) <= 0 {
		return nil, dbutil694.NewErrParamIsEmpty("ids")
	}
	sql = dbutil694.TakePlaceHolder(sql, "@in-1626687378", len(ids))
