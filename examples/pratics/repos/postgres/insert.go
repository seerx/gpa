...
// Generated by mro at 2021-07-16 17:38:34
package postgres
...
func (userRepo *UserRepo) Insert(ctx context.Context, user *models.User, name string) (*models.User, error) {
	...
	var var1tp *dbutil162.TimeProp
	var1tp, err = dbutil162.NewTimeProp("DATETIME", true, "")
	if err != nil {
		return nil, err
	}
	var1 := dbutil162.FormatColumnTime(userRepo.p.GetTimeStampzFormat(),
