...
// Generated by mro at 2021-07-16 11:21:26
package postgres
...
func (userRepo *UserRepo) Insert(ctx context.Context, user *models.User, name string) (*models.User, error) {
	...
	var var1tp *dbutil318.TimeProp
	var1tp, err = dbutil318.NewTimeProp("DATETIME", true, "")
	if err != nil {
		return nil, err
	}
	var1 := dbutil318.FormatColumnTime(userRepo.p.GetTimeStampzFormat(),
