...
import (
	context "context"
	dbutil847 "github.com/seerx/gpa/rt/dbutil"
...
func (userRepo *UserRepo) Insert(ctx context.Context, user *models.User, name string) (*models.User, error) {
	...
	var var1tp *dbutil847.TimeProp
	var1tp, err = dbutil847.NewTimeProp("DATETIME", true, "")
	if err != nil {
		return nil, err
	}
	var1 := dbutil847.FormatColumnTime(userRepo.p.GetTimeStampzFormat(),
