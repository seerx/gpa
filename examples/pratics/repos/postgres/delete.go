...
// Generated by mro at 2021-07-16 11:21:25
package postgres

import (
	dbutil81 "github.com/seerx/gpa/rt/dbutil"
...
func (delete *Delete) DeleteByAgeAndCret(user *models.User) (int64, *models.User, error) {
	...
	var var3tp *dbutil81.TimeProp
	var3tp, err = dbutil81.NewTimeProp("DATETIME", true, "")
	if err != nil {
		return 0, nil, err
	}
	var3 := dbutil81.FormatColumnTime(delete.p.GetTimeStampzFormat(),
...
func (delete *Delete) DeleteName(user *models.User, name string, ages []int) (int64, error) {
	var err error
	sql := "DELETE FROM \"user\" WHERE id=? and age in (@in-1626405686)"
	var sqlParams []interface{}
	// where 参数
	sqlParams = append(sqlParams, user.ID)
	if len(ages) <= 0 {
		return 0, dbutil81.NewErrParamIsEmpty("ages")
	}
	sql = dbutil81.TakePlaceHolder(sql, "@in-1626405686", len(ages))
