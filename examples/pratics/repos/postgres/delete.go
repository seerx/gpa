...
// Generated by mro at 2021-07-19 17:36:17
package postgres
...
func (delete *Delete) DeleteByAgeAndCret(user *models.User) (int64, *models.User, error) {
	...
	var var3tp *dbutil456.TimeProp
	var3tp, err = dbutil456.NewTimeProp("DATETIME", true, "")
	if err != nil {
		return 0, nil, err
	}
	var3 := dbutil456.FormatColumnTime(delete.p.GetTimeStampzFormat(),
...
func (delete *Delete) DeleteName(user *models.User, name string, ages []int) (int64, error) {
	var err error
	sql := "DELETE FROM \"user\" WHERE id=? and age in (@in-1626687377)"
	var sqlParams []interface{}
	// where 参数
	...
	sql = dbutil456.TakePlaceHolder(sql, "@in-1626687377", len(ages))
